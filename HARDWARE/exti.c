...
void EXTI_Configuration(GPIO_TypeDef *GPIO, uint16_t GPIO_Pin, u8 Trigger)
{
    ...
    if (GPIO == GPIOA)
    {
        GPIO_PORT_SOURCE = GPIO_PortSourceGPIOA;
        RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOA, ENABLE);
    }
    else if (GPIO == GPIOB)
    {
        GPIO_PORT_SOURCE = GPIO_PortSourceGPIOB;
        RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOB, ENABLE);
    }
    else if (GPIO == GPIOC)
    {
        GPIO_PORT_SOURCE = GPIO_PortSourceGPIOC;
        RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOC, ENABLE);
    }
    else if (GPIO == GPIOD)
    {
        GPIO_PORT_SOURCE = GPIO_PortSourceGPIOD;
        RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOD, ENABLE);
    }
    else if (GPIO == GPIOE)
    {
        GPIO_PORT_SOURCE = GPIO_PortSourceGPIOE;
    ...
    else if (GPIO_Pin == GPIO_Pin_4 )
    {
        ...
        GPIO_PIN_SOURCE = GPIO_PinSource4;
    }
