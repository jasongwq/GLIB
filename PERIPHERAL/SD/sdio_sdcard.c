...
//ALIENTEK STM32开发板
//SDIO 驱动代码(改自ST官方SDIO例程,感谢网友mygod提供的参考代码)
//正点原子@ALIENTEK
...
//V1.1修改说明
//1,修改部分定义,减少内存占用.
//2,修改CardCapacity类型,使之支持高容量卡
//3,修改对MMC卡的支持.
//4,增加对写数据时出错的处理,防假死
//5,目前该版本通杀所有SD卡包括MMC卡
//V1.1修改说明
//1,修正SD_ReadDisk和SD_WriteDisk在4字节对齐处理上的bug
////////////////////////////////////////////////////////////////////////////////////////////////////
...
SD_Error SD_Init(void)
{
    ...
    //中断优先级NVIC设置
    NVIC_InitStructure.NVIC_IRQChannel = SDIO_IRQn;  //TIM3中断
    ...
    {
        SDIO_Clock_Set(SDIO_TRANSFER_CLK_DIV);          //设置时钟频率,SDIO时钟计算公式:SDIO_CK时钟=SDIOCLK/[clkdiv+2];其中,SDIOCLK一般为72Mhz
...
//SDIO发送命令函数
//cmdindex:命令索引,低六位有效
//waitrsp:期待的相应.00/10,无响应;01,短相应;11,长响应
//arg:参数
...
//    {
//    case SDIO_STD_CAPACITY_SD_CARD_V1_1: USART_OUT(DEBUG_USART,"Card Type:SDSC V1.1\r\n"); break;
//    case SDIO_STD_CAPACITY_SD_CARD_V2_0: USART_OUT(DEBUG_USART,"Card Type:SDSC V2.0\r\n"); break;
//    case SDIO_HIGH_CAPACITY_SD_CARD:     USART_OUT(DEBUG_USART,"Card Type:SDHC V2.0\r\n"); break;
//    case SDIO_MULTIMEDIA_CARD:           USART_OUT(DEBUG_USART,"Card Type:MMC Card \r\n"); break;
//    }
//    USART_OUT(DEBUG_USART,"Card ManufacturerID:%d\r\n", SDCardInfo.SD_cid.ManufacturerID);   //制造商ID
//    USART_OUT(DEBUG_USART,"Card RCA:%d\r\n", SDCardInfo.RCA);                              	//卡相对地址
//    USART_OUT(DEBUG_USART,"Card Capacity:%d MB\r\n", (u32)(SDCardInfo.CardCapacity >> 20)); 	//显示容量
//    USART_OUT(DEBUG_USART,"Card BlockSize:%d\r\n\r\n", SDCardInfo.CardBlockSize);          	//显示块大小
//}
