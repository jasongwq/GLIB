...
//}
//extern u8 TIM5_CAPTURE_STA_CH1;//输入捕获状态
//extern u16 TIM5_CAPTURE_VAL_CH1;//输入捕获值
//u32 ultrasonic (void)
//{
//    u32 temp = 0;
//    TRIG_H;
//    TIM5_CAPTURE_STA_CH1 = 0; //开启下一次捕获
//    delay_us(10);
//    TRIG_L;
//    while (1)
//    {
//        if (TIM5_CAPTURE_STA_CH1 & 0X80) //成功捕获到了一次上升沿
//        {
//            temp = TIM5_CAPTURE_STA_CH1 & 0X3F;
//            temp *= 65536;//溢出时间总和
//            temp += TIM5_CAPTURE_VAL_CH1; //得到总的高电平时间
