...
#define VS_DQ_RCC   RCC_APB2Periph_GPIOD
#define VS_DQ_GPIO  GPIOD
#define VS_DQ_PIN   GPIO_Pin_9
#define VS_RST_RCC  RCC_APB2Periph_GPIOD
#define VS_RST_GPIO GPIOD
#define VS_RST_PIN  GPIO_Pin_10
#define VS_XCS_RCC  RCC_APB2Periph_GPIOB
#define VS_XCS_GPIO GPIOB
#define VS_XCS_PIN  GPIO_Pin_12
#define VS_XDCS_RCC  RCC_APB2Periph_GPIOD
#define VS_XDCS_GPIO GPIOD
#define VS_XDCS_PIN  GPIO_Pin_8
#define VS_DQ       GPIO_ReadInputDataBit(VS_DQ_GPIO,VS_DQ_PIN)
#define VS_RST_H    GPIO_SetBits(VS_RST_GPIO,VS_RST_PIN);
#define VS_RST_L    GPIO_ResetBits(VS_RST_GPIO,VS_RST_PIN);
#define VS_XCS_H    GPIO_SetBits(VS_XCS_GPIO,VS_XCS_PIN);
#define VS_XCS_L    GPIO_ResetBits(VS_XCS_GPIO,VS_XCS_PIN);
#define VS_XDCS_H   GPIO_SetBits(VS_XDCS_GPIO,VS_XDCS_PIN);
#define VS_XDCS_L   GPIO_ResetBits(VS_XDCS_GPIO,VS_XDCS_PIN);
